        ...
        <div class="container">
            ...
            <nav class="navigation closed clearfix">
                ...
                <ul class="sf-menu nav">
                    ...
                    <li><a href="#sponsors">Venues</a></li>
                    <li><a href="#speakers">Wine Brands</a></li>
                    <li><a href="#price">Contact us</a></li>
                    <li><a href="#location">Location</a></li>
                    <li>
                        <a href="#"><img src="flags/vn.png" class="img-responsive" alt="Image"></a>
                    </li>
                    <li>
                        <a href="#"><img src="flags/us.png" class="img-responsive" alt="Image"></a>
                    </li>
                </ul>
            </nav>
            <!-- /Navigation -->
            ...
            <div class="container">
                ...
                <form name="af-form" method="post" action="" class="af-form row" id="af-form">
                    ...
                    <div class="col-sm-12 af-outer af-required text-center">
                        <div class="form-group af-inner">
                            <input type="submit" name="submit" class="form-button form-button-submit btn btn-theme btn-theme-lg btn-theme-transparent" id="submit_btn" value="Submit" />
                        </div>
                    </div>
