...
get_header( 'shop' ); ?>
	...
	<div class="container" style="overflow: hidden; padding-bottom: 10px;">
	    <div class="row banner-detail-news">
	        <div id="owl-dv-vt" class="owl-theme" style="margin-top: 10px;">
	            <div class="item">
	                <a href="/tin-tuc/goi-tha-ga--vi-vu-luot-net-nid6002.html">
	                    <img src="<?php echo template_directory;?>/images/Advertises/sim-bigbang-dm-2_1607431109092016.jpg" alt="bigbang">
	                </a>
	            </div>
