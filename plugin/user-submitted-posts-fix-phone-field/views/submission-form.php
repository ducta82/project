...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<?php } if (($usp_options['usp_phone'] == 'show' || $usp_options['usp_phone'] == 'optn') && ($usp_options['usp_use_phone'] == false)) { ?>
		
		<fieldset class="usp-phone">
			<label for="user-submitted-phone"><?php _e('Your Phone', 'usp'); ?></label>
			<input name="user-submitted-phone" type="number" value="" placeholder="<?php _e('Your Phone', 'usp'); ?>"<?php if (usp_check_required('usp_phone')) echo $required; ?> class="usp-input">
		</fieldset>
