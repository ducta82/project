...
class WC_Points_Rewards_Actions {
	...
	public function points_rewards_action_settings( $settings ) {
		...
		$settings = array_merge(
			...
			array(
				array(
					'title'    => __( 'Points earned for account signup', 'wc_advanced_points' ),
	...
	public function add_action_event_descriptions( $event_description, $event_type, $event ) {
		...
		switch ( $event_type ) {
			case 'product-review': $event_description = sprintf( __( '%s earned for product review', 'wc_advanced_points' ), $points_label ); break;
			case 'account-signup': $event_description = sprintf( __( '%s earned for account signup', 'wc_advanced_points' ), $points_label ); break;
			case 'birthday': $event_description = sprintf( __( '%s earned for birthday', 'wc_advanced_points' ), $points_label ); break;
			case 'marriage': $event_description = sprintf( __( '%s earned for marriage', 'wc_advanced_points' ), $points_label ); break;
		}
