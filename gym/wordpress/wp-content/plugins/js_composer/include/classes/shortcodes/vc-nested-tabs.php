...
class WPBakeryShortCode_VC_Nested_Tab extends WPBakeryShortCode_VC_Column {
...
vc_add_shortcode_param('tab_id', 'nested_tab_id_settings_field');*/
...
class WPBakeryShortCode_VC_Nested_Tabs extends WPBakeryShortCode {
    ...
    public function contentAdmin($atts, $content = null) {
        ...
        */
        ...
        $tmp = '';
        if( count($tab_titles) ) {
            $tmp .= '<ul class="clearfix nested_tabs_controls">';
    ...
    public function getTabTemplate() {
        return '<div class="wpb_template">'.do_shortcode('[vc_nested_tab title="Tab" tab_id=""][/vc_nested_tab]').'</div>';
    }
