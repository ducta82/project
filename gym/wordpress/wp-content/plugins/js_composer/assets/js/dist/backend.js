...
function($) {
    ...
    _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
        ...
        initialize: function() {
            _.bindAll(this, "setSize", "setTabsSize", "fixElContainment", "hookDependent"), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this), this.on("render", this.setTitle, this),
...
}(window.jQuery), _.isUndefined(window.vc) && (window.vc = {}), "undefined" == typeof window.setCookie && (window.setCookie = function(c_name, value, exdays) {
        var exdate = new Date;
        ...
        var GoogleFonts = Backbone.View.extend({
            ...
            VC_AutoComplete = Backbone.View.extend({
                ...
                createBox: function(item) {
                    ...
                    this.updateItems(), $label = $('<li class="vc_autocomplete-label vc_data" data-index="' + index + '" data-value="' + item.value + '" data-label="' + item.label + '"><span class="vc_autocomplete-label"><a>' + item.label + "</a></span>" + remove + "</li>"), $label.insertBefore(this.$el_wrap),
    ...
    function($) {
        vc.clone_index = 1, vc.shortcode_view = Backbone.View.extend({
            ...
            render: function() {
                ...
                if ($shortcode_template_el.is("script")) this.html2element($shortcode_template_el.html());
                else {
        ...
        attachmentCompatRender = _.extend(media.view.AttachmentCompat.prototype.render), media.view.AttachmentCompat.prototype.render = function() {
            ...
            init: function() {
                $("body").unbind("click.vcGalleryWidget").on("click.vcGalleryWidget", ".gallery_widget_add_images", function(event) {
                    ...
                    return media.vc_editor.$vc_editor_element = $(this), "true" === $this.attr("use-single") ? void media.VcSingleImage.frame(this).open("vc_editor") : ($this.blur(),
                        void media.vc_editor.open(editor))
                })
            }
