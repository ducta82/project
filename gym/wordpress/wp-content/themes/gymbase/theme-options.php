					...
					<ul class="form_field_list">
						...
						<li>
							...
							<div>
								...
								<input type="text" class="regular-text color" value="<?php echo esc_attr($theme_options["submenu_hover_color"]); ?>" id="submenu_color" name="submenu_hover_color" data-default-color="000000">
							</div>
						</li>
					</ul>
				</div>
